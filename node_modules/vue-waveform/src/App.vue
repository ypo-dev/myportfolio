<template>
  <div id="app">
   <div v-show="isshow">
     <vue-waveplayer @updateTimeEnded="updateTimeEnded"  @ready=ready ref="mycom" :range="0.1" :openAudioContext="false" :WIDTH="rangeV" :HEIGHT="128" bgColor="#fff" :playType="playtype" :URL="URL"  ></vue-waveplayer>
   </div>
   ...
   <select v-model="web">
     ...
     <option value ="./static/hhh.aac">./static/hhh.aac</option>
